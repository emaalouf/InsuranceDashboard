...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.casesMenu.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.cases-menus.update", [$casesMenu->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label for="case_name">{{ trans('cruds.casesMenu.fields.case_name') }}</label>
                <input class="form-control {{ $errors->has('case_name') ? 'is-invalid' : '' }}" type="text" name="case_name" id="case_name" value="{{ old('case_name', $casesMenu->case_name) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('car_make') ? 'is-invalid' : '' }}" type="text" name="car_make" id="car_make" value="{{ old('car_make', $casesMenu->car_make) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('car_year') ? 'is-invalid' : '' }}" type="text" name="car_year" id="car_year" value="{{ old('car_year', $casesMenu->car_year) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('case_date') ? 'is-invalid' : '' }}" type="text" name="case_date" id="case_date" value="{{ old('case_date', $casesMenu->case_date) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('parts') ? 'is-invalid' : '' }}" type="text" name="parts" id="parts" value="{{ old('parts', $casesMenu->parts) }}" required>
                @if($errors->has('parts'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('parts_price') ? 'is-invalid' : '' }}" type="text" name="parts_price" id="parts_price" value="{{ old('parts_price', $casesMenu->parts_price) }}" required>
